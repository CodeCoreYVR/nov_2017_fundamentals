...
// This one is fairly simple, we just need you to do some math
// Take the celsius temperature and plug it into the formula
...
// Hint: To make this more clean you should wrap the code for each of the
//       options up in a function and call the function in the if else statement
//       If this does not make sense dont do it I'll help you with it next time.
